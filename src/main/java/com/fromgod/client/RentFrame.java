...
public class RentFrame extends javax.swing.JFrame {
    ...
    ArrayList<Customer> cusArray;//array of customers
    ArrayList<Vehicle> vehArray;//array of vehicles
    ...
    public RentFrame(ClientApp cli) {
        super("Rent Vehicle");
        initComponents();
        ...
        cusArray = (ArrayList<Customer>) client.communicate("get customers");   //we get the list of customers from the server through a req
    ...
    private void comboCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboCatActionPerformed
        ...
        if(categoryName.equalsIgnoreCase("sedan")){
            //array of Vehicles
            vehArray = (ArrayList<Vehicle>) client.communicate("get vehicles sedan");   //get all vehicles from the server 
             ArrayList<Vehicle> listFilter = filterVeh("Sedan", vehArray);              //filter the vehicles by category
            ...
            vehArray = (ArrayList<Vehicle>) client.communicate("get vehicles suv");     //get all vehicles from the server 
            ArrayList<Vehicle> listFilter = filterVeh("SUV", vehArray);                 //filter the vehicles by category
